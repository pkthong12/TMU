...
export class CompetencyComponent extends BaseComponent {
  ...
  title = EnumTranslateKey.UI_COMPONENT_TITLE_HU_COMPETENCY;

  apiDefinition: ICorePageListApiDefinition = {
    queryListRelativePath: api.HU_COMPETENCY_QUERY_LIST,
  }

  crud: ICorePageListCRUD = {
    deleteIds: api.HU_COMPETENCY_DELETE_IDS,
    toggleActiveIds: api.HU_COMPETENCY_TOGGLE_ACTIVE_IDS,
  }
  ...
  columns: ICoreTableColumnItem[] = [
    ...
    {
      caption: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_HU_COMPETENCY_IS_ACTIVE,
      field:  'status',
      type: 'string',
      align: 'center',
      width: 150,
    ...
    {
      caption: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_HU_COMPETENCY_CODE,
      field: 'code',
      type: 'string',
      align: 'left',
      width: 250
    ...
    {
      caption: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_HU_COMPETENCY_NAME,
      field: 'name',
      type: 'string',
      align: 'left',
      width: 300,
    ...
    {
      caption: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_HU_COMPETENCY_GROUP_COMPETENCY,
    ...
    {
      caption: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_HU_COMPETENCY_NOTE,
      field: 'note',
      type: 'string',
      align: 'left',
      width: 300,
  ...
  onRowDoubleClick(e: any): void {
    ...
    this.router.navigate(
      [
        {
          outlets: {
            competency: [btoa('' + e.id), { listInstance: this.corePageListInstanceNumber }],
          },
        },
      ],
      ...
      case EnumCoreButtonVNSCode.HEADER_CREATE:
        this.router.navigate(
          [
            {
              outlets: {
                competency: [btoa('0'), { listInstance: this.corePageListInstanceNumber }],
              },
            },
          ],
          { relativeTo: this.route.parent },
          ...
          if(this.selectedIds.length == 1){
            this.router.navigate(
              [
                {
                  outlets: {
                    competency: [btoa('' + this.selectedIds[0]), { listInstance: this.corePageListInstanceNumber }],
                  },
                },
              ],
              { relativeTo: this.route.parent },
