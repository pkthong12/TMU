...
@Component({
  ...
  styleUrl: './aspect.component.scss'
})
export class AspectComponent extends BaseComponent implements AfterViewInit {
  ...
  apiDefinition: ICorePageListApiDefinition = {
    queryListRelativePath: api.HU_COMPETENCY_ASPECT_QUERY_LIST,
  };

  listInstance!: number;

  crud: ICorePageListCRUD = {
    deleteIds: api.HU_COMPETENCY_ASPECT_DELETE_IDS,
    toggleActiveIds: api.HU_COMPETENCY_ASPECT_TOGGLE_ACTIVE_IDS,
  };
  ...
  columns: ICoreTableColumnItem[] = [
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_HU_LIST_COMPETENCY_CODE_ASPECT,
      field: 'code',
      type: 'string',
      align: 'left',
      width: 250,
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_HU_LIST_COMPETENCY_COMPETENCY,
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_HU_COMPETENCY_GROUP,
      ...
      case EnumCoreButtonVNSCode.HEADER_CREATE:
        this.router.navigate(
          [
            {
              outlets: {
                aspect: [btoa('0'), { listInstance: this.corePageListInstanceNumber }],
              },
            },
          ],
          ...
          if (this.selectedIds.length == 1) {
            this.router.navigate(
              [
                {
                  outlets: {
                    aspect: [btoa(this.selectedIds[0]), { listInstance: this.corePageListInstanceNumber }],
                  },
                },
              ],
              { relativeTo: this.route.parent },
  ...
  onRowDoubleClick(e: any): void {
    ...
    this.router.navigate(
      [
        {
          outlets: {
            aspect: [btoa(e.id), { listInstance: this.corePageListInstanceNumber }],
          },
        },
      ],
      { relativeTo: this.route.parent },
