...
@Component({
  ...
  templateUrl: './tr-prepare-edit.component.html',
  styleUrl: './tr-prepare-edit.component.scss'
})
export class TrPrepareEditComponent  extends BaseEditComponent{
