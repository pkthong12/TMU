...
import { BaseComponent, ICorePageListApiDefinition, ICorePageListCRUD, ISortItem, EnumSortDirection, ICoreTableColumnItem, ICorePageListEditRouting, MultiLanguageService } from 'ngx-histaff-alpha';
