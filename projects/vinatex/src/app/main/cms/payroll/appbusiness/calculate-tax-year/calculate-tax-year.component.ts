...
import { BaseComponent, EnumCoreButtonVNSCode, EnumCoreOrgTreeaAccessorMode, ICoreDropdownOption, ISearchItem, ICoreTableColumnItem, IPagination, defaultPaging, MultiLanguageService, AppService, ResponseService, AlertService, AuthService, LayoutService, JsonService, ICoreButtonVNS, IFormatedResponse, alertOptions, EnumCoreTablePipeType, ICoreTableFlatColumnItem } from 'ngx-histaff-alpha';
