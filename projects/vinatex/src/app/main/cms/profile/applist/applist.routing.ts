...
export const ProfileListRoutes: Routes = [
  ...
  {
    path: 'listfundsource',
    loadChildren: () => import('../../payroll/applist/list-fund-source/list-fund-source.module').then((m) => m.ListFundSourceModule),
  },
  {
    path: "commendcategory",
    loadChildren: () => import("../../attendance/applist/salaryperiod/salaryperiod.module").then(m => m.SalaryPeriodModule),
  },
  {
    path: 'ins-wherehealth',
    loadChildren: () => import('../../profile/appbusiness/ins-wherehealth/ins-wherehealth.module').then((m) => m.InsWherehealthModule),
  },
  {
    path: 'province',
    loadChildren: () =>
  ...
  {
    path: 'hu-personnel-planing',
    loadChildren: () => import('../applist/hu-personnel-planing/hu-personnel-planing.routes').then((r) => r.routes)
  },
  {
    path: 'district',
    loadChildren: () =>
