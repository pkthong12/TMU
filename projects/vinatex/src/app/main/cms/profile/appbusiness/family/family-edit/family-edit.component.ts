    ...
    },
    {
      rows: [
        [
          ...
          {
            flexSize: 3,
            label: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_FAMILY_COMPANY_NAME,
            field: 'companyName',
            value: '',
            controlType: EnumFormBaseContolType.TEXTBOX,
            type: 'text',
          ...
          {
            flexSize: 3,
            label: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_FAMILY_POSITION_NAME_FAMILY,
            field: 'positionNameFamily',
            value: '',
            controlType: EnumFormBaseContolType.TEXTBOX,
            type: 'text',
          },
