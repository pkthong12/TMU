...
export class LeaveJobComponent extends BaseComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    setTimeout(() => {
      this.subscriptions.push(
        this.appService.get(api.SYS_OTHERLIST_GETOTHERLISTBYTYPE + "TERMINATE_INFORMATION_PRINTING_FORM").subscribe(x => {
  ...
  onSelectedIdsChange(e: string[] | number[]): void {
    this.selectedIds = e;
  }
