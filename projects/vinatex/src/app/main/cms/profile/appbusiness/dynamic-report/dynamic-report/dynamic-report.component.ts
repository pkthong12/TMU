        ...
        if (x.ok && x.status === 200) {
          ...
          if (body.statusCode === 200) {
            // const options: ICoreDropdownOption[] = [];
              ...
              //       break;
              //       case "API.Entities.REPORT_DATA_WAGE":
              //       this.prefixTrans = 'UI_ENTITY_FIELD_CAPTION_WAGE_'
              //       break;
    ...
    switch (e.code) {
      ...
      case EnumCoreButtonVNSCode.HEADER_DELETE:
        ...
        case EnumCoreButtonVNSCode.HEADER_EXPORTEXEL:
          ...
          if(this.selectedDataChange.length === 0){
            this.alertService.warn(this.mls.trans(EnumTranslateKey.UI_COMPONENT_TITLE_DYNAMIC_REPORT_MUST_CHOOSE_ONE_RECORD), alertOptions);

            return;
          }
          if(this.orgIds?.length == 0 || !!!this.orgIds){
            this.alertService.warn(this.mls.trans(EnumTranslateKey.UI_COMPONENT_TITLE_DYNAMIC_REPORT_MUST_CHOOSE_ORG), alertOptions);
            return;
          }
          ...
          this.appService.blobPost(api.GET_LIST_BY_CONDITION_TO_EXPORT,request1).subscribe(res => {
            if(!!res){
              ...
              this.dynamicReportChange(this.dynamicReport)
            }
          });
          break;
      default:
  ...
  dynamicReportChange(event : any){
    ...
    switch(req.viewName){
      case "API.Entities.REPORT_DATA_STAFF_PROFILE":
        ...
        this.prefixTrans = 'UI_ENTITY_FIELD_CAPTION_WAGE_'
        break;
        case "API.Entities.REPORT_DATA_CONTRACT":
        this.prefixTrans = 'UI_ENTITY_FIELD_CAPTION_CONTRACT_'
        break;
        case "API.Entities.REPORT_DATA_DECISION":
        this.prefixTrans = 'UI_ENTITY_FIELD_CAPTION_DECISION_'
        break;
        case "API.Entities.REPORT_DATA_FAMILY":
        this.prefixTrans = 'UI_ENTITY_FIELD_CAPTION_FAMILY_'
        break;
      default:
        break;
    }
