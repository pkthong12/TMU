...
import { AppService, BaseEditComponent, DialogService, EnumCoreTablePipeType, EnumFormBaseContolType, ICoreFormSection, ICorePageEditCRUD } from 'ngx-histaff-alpha';
...
export class TrainingCourseEditComponent extends BaseEditComponent {
  ...
  // TRAIN_FEILD
  trainFeildOptions$ = new BehaviorSubject<any>(null);
