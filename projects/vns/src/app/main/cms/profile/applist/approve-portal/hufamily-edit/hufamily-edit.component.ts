...
import { BaseComponent, EnumCoreTablePipeType, EnumSortDirection, ICorePageListApiDefinition, ICorePageListCRUD, ICorePageListEditRouting, ICoreTableColumnItem, IInOperator, ISortItem, MultiLanguageService, OrganizationService } from 'ngx-histaff-alpha';
...
export class HufamilyEditComponent extends BaseComponent implements OnInit {
  ...
  @ViewChild('modelChange') modelChange!: TemplateRef<any>;
  modelChangeTemplateRef!: TemplateRef<any>;
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      ...
      this.columns.filter(c => c.field === 'modelChange')[0].templateRef = this.modelChange;
