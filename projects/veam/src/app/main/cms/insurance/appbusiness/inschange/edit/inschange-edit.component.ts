...
export class InsChangeEditComponent
  ...
  createForm() {
    ...
    this.subscriptions.push(
      this.form.get('changeTypeId')?.valueChanges.subscribe((x) => {
  ...
  disableControl(e: any) {
    ...
    if (this.listTruyThu.includes(e.code)) {
      ...
      this.form.get('salaryBhxhOld')?.setValue(null);
      this.form.get('salaryBhytOld')?.setValue(null);
      this.form.get('salaryBhtnOld')?.setValue(null);
      this.form.get('salaryBhbnnOld')?.setValue(null);
      ...
      this.form.get('salaryBhxhNew')?.setValue(null);
      this.form.get('salaryBhytNew')?.setValue(null);
      this.form.get('salaryBhtnNew')?.setValue(null);
      this.form.get('salaryBhbnnNew')?.setValue(null);
      //mo dong thoai thuy
      ...
      this.form.get('salaryBhtnOld')?.enable();
      //gan lai gia tri
      this.form.get('salaryBhxhOld')?.setValue(this.form.get('salaryBhxhOld')?.value);
      this.form.get('salaryBhytOld')?.setValue(this.form.get('salaryBhytOld')?.value);
      this.form.get('salaryBhtnOld')?.setValue(this.form.get('salaryBhtnOld')?.value);
      this.form.get('salaryBhbnnOld')?.setValue(this.form.get('salaryBhbnnOld')?.value);
      this.form.get('salaryBhxhNew')?.enable();
      this.form.get('salaryBhytNew')?.enable();
      this.form.get('salaryBhbnnNew')?.enable();
      this.form.get('salaryBhtnNew')?.enable();
