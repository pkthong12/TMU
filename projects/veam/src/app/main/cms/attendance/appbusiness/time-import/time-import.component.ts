    ...
    switch (e.code) {
      ...
      case EnumCoreButtonVNSCode.HEADER_EDIT:
        if (this.selectedIds.length == 1) {
          ...
          this.alertService.warn("Phải chọn 1 bản ghi", alertOptions);
        }
        break;
      default:
        break;
                ...
                if (response.type === 'application/octet-stream') {
                  ...
                  reader.onload = () => {
                    ...
                    if (data.statusCode == 200) {
                      this.alertService.success(this.mls.trans(data.messageCode), alertOptions);
                    }
                    else {
                      this.alertService.error(this.mls.trans(data.messageCode), alertOptions);
                    }
                  };
