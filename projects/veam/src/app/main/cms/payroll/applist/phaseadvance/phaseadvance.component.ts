...
export class PhaseAdvanceComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  */
  ...
  columns: ICoreTableColumnItem[] = [
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_PA_PHASE_ADVANCE_DAY,
      field: 'phaseDay',
      type: 'string',
      align: 'left',
      width: 150,
    ...
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_PA_PHASE_ADVANCE_FROM_SALARY,
      field: 'fromSalaryName',
      type: 'string',
      align: 'left',
      width: 150,
    },
    {
      caption: EnumTranslateKey.UI_COMPONENT_TITLE_PA_PHASE_ADVANCE_TO_SALARY,
      field: 'toSalaryName',
      type: 'string',
      align: 'left',
      width: 150,
