...
import { BaseComponent, EnumCoreButtonVNSCode, EnumCoreOrgTreeaAccessorMode, ICoreDropdownOption, ISearchItem, ICoreTableColumnItem, IPagination, defaultPaging, MultiLanguageService, AppService, AlertService, AuthService, LayoutService, JsonService, ICoreButtonVNS, alertOptions, IFormatedResponse, EnumCoreTablePipeType, ICoreTableFlatColumnItem, EnumSortDirection, ISortItem } from 'ngx-histaff-alpha';
