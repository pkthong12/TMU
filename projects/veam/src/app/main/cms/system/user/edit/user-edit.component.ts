    ...
    [
      {
        ...
        rows: [
          [
            ...
            {
              flexSize: 6,
              label: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_SYS_USER_EMAIL,
              field: 'email',
              value: '',
              controlType: EnumFormBaseContolType.TEXTBOX,
              type: 'email',
              validators: [
                {
                  ...
                  errorMessage: EnumTranslateKey.UI_FORM_CONTROL_ERROR_EMAIL,
                }
              ],
            },
          ],
          ...
          [
            {
              flexSize: 6,
              label: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_SYS_USER_IS_MOBILE,
              field: 'isMobile',
              value: false,
              controlType: EnumFormBaseContolType.CHECKBOX,
              type: 'boolean',
    ...
    setTimeout(() => {
      ...
      this.subsctiptions.push(
        this.userEditService.getUserGroupList()
          .pipe(
            map((x: any) => {
              const header = (x as HttpResponse<any>).headers.get('X-Message-Code')
              console.log("this.userEditService.getUserGroupList() map header", header)
