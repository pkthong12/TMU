...
export class UserComponent extends BaseComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild('isMobile') isMobile!: TemplateRef<any>;
  ...
  */
  ...
  columns: ICoreTableColumnItem[] = [
    ...
    {
      caption: EnumTranslateKey.UI_ENTITY_FIELD_CAPTION_SYS_USER_IS_MOBILE,
      field: 'isMobile',
      type: 'boolean',
      align: 'center',
      width: 180,
      templateRef: this.isMobile,
    },
    {
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      ...
      this.columns.filter(c => c.field === 'isMobile')[0].templateRef = this.isMobile;
    })
  }
