...
import { BaseEditComponent, ICoreDropdownOption, ICorePageEditCRUD, ICoreFormSection, EnumFormBaseContolType, EnumCoreFormControlSeekerSourceType, DialogService, AppService, IFormatedResponse, EnumCoreTablePipeType } from 'ngx-histaff-alpha';
...
export class BasicEditComponent extends BaseEditComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.crud = {
      ...
      u: api.HU_EMPLOYEE_CV_GENERAL_INFO_UPDATE2,
    };
