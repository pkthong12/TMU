        ...
        if (!!x) {
          this.appService
            ...
            .subscribe((res: any) => {
              ...
              {
                this.alertService.warn("Nhân viên chưa được thêm mới hợp đồng", alertOptions);
              }
              res.body.innerBody.map((g: any) => {
                options.push({
                  value: g.id,
