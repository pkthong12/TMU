    ...
    },
    {
      ...
      rows: [
        ...
        [
          ...
          {
            flexSize: 3,
            label: EnumTranslateKey.UI_COMPONENT_LABEL_DECISION_IS_RESPONSIBLE_SALARY,
            field: 'isResponsibleSalaryCur',
            value: '',
            controlType: EnumFormBaseContolType.CHECKBOX,
            type: 'boolean',
            disabled: true,
              ...
              this.appService.get(url).subscribe((res: any) => {
                if (!!res.ok && res.status === 200) {
                  ...
                  if (body.statusCode === 200 && !!body.innerBody) {
                    ...
                    this.form.get('isResponsibleSalaryCur')?.patchValue(body.innerBody.isResponsibleSalary);
                    //when created
                    if (!id) {
