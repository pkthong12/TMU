...
export class TrplanEditComponent extends BaseEditComponent {
  ...
  unitMoneyOptions$ = new BehaviorSubject<ICoreDropdownOption[]>([]);
  unitMoneyGetByIdObject$ = new BehaviorSubject<any>(null);
  unitMoneyGetByIdApi = api.SYS_OTHERLIST_READ;
  ...
  sections: ICoreFormSection[] = [
    {
      ...
      rows: [
        ...
        [
          ...
          {
            flexSize: 3,
            label: EnumTranslateKey.UI_COMPONENT_TITLE_TR_PLAN_COSTS,//chi phi dao tao
            field: 'expectedCost',
            value: '',
            controlType: EnumFormBaseContolType.CURRENCY,
            readonly: false,
          ...
          {
            flexSize: 3,
            label: EnumTranslateKey.UI_COMPONENT_TITLE_TR_PLAN_UNIT_MONEY,//don vi tien te
            field: 'unitMoneyId',
            value: '',
            controlType: EnumFormBaseContolType.DROPDOWN,
            readonly: false,
            type: 'number',
            shownFrom: 'name',
            getByIdObject$: this.unitMoneyGetByIdObject$,
            getByIdApi: this.unitMoneyGetByIdApi,
            dropdownOptions$: this.unitMoneyOptions$,
          },
          {
            flexSize: 3,
        ...
        if (item.body.statusCode == 200 && item.ok == true) {
          ...
          switch (param) {
            ...
            case 'TYPE_TRAINING':
              ...
              break;
            case 'CURRENCY':
              this.unitMoneyOptions$.next(options);
              break;
            default:
              break;
          }
